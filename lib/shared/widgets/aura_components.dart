...
// ─────────────────────────────────────────────────────────
// Aura 6.0 — Execution Engine Components
//
...
class AuraLabel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final textTheme = context.auraText;
    return Text(
      text.toUpperCase(),
...
class AuraMetric extends StatelessWidget {
  final String whole;
...
class AuraStatBox extends StatelessWidget {
  final String label;
  final String value;
...
class AuraAllocRow extends StatelessWidget {
  final String name;
  final String detail;
...
class AuraDivider extends StatelessWidget {
  final bool onPanel;
  const AuraDivider({super.key, this.onPanel = false});
...
class AuraVoiceButton extends StatelessWidget {
  final VoidCallback? onTap;

  const AuraVoiceButton({super.key, this.onTap});
