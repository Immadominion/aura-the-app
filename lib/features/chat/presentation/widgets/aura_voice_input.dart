...
/// Voice-first input widget for Aura chat.
///
...
class AuraVoiceInput extends StatefulWidget {
  ...
  @override
  State<AuraVoiceInput> createState() => _AuraVoiceInputState();
}

class _AuraVoiceInputState extends State<AuraVoiceInput>
  ...
  @override
  void didUpdateWidget(AuraVoiceInput old) {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          AuraVoiceButton(onTap: isLoading ? null : onMicTap),
